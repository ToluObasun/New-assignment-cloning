...
namespace Wema.BIT.User
{
    public class User
    {
        public static void Main(string[] args)
        {
            ...
            {
                new Account() {Id =1, AccountNumber="12340968", BVN="244544", AccountName="ObasunTolu", PhoneNumber="09164536678" },

                new Account() {Id =2, AccountNumber="12340968", BVN="244544", AccountName="ObasunTolu", PhoneNumber="09164536678" },

                new Account() {Id =3, AccountNumber="12340968", BVN="244544", AccountName="ObasunTolu", PhoneNumber="09164536678" },

                new Account() {Id =4, AccountNumber="12340968", BVN="244544", AccountName="ObasunTolu", PhoneNumber="09164536678" },

                new Account() {Id =5, AccountNumber="12340968", BVN="244544", AccountName="ObasunTolu", PhoneNumber="09164536678" },
            };
